...
This link can also be used with `cbsodataR` using the `cbs_get_data_from_link` function. For example
the link https://opendata.cbs.nl/dataportaal/#/CBS/en/dataset/71509ENG/table?dl=193CB refers to a certain selection within the table.
